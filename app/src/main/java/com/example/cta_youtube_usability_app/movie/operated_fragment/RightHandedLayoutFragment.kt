...
import com.example.cta_youtube_usability_app.databinding.FragmentRightHandedLayoutBinding
import com.google.android.material.bottomnavigation.BottomNavigationView

class RightHandedLayoutFragment : Fragment() {

    private val binding by lazy(LazyThreadSafetyMode.NONE) {
        FragmentRightHandedLayoutBinding.inflate(layoutInflater)
    }
...
//    val controllerFuture = MediaController.Builder(requireContext(),token).buildAsync()
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        Log.e("RightHandedLayoutFragment", "遷移しました")
...
//        }, MoreExecutors.directExecutor())
    ...
    private fun releasePlayer() {
        player?.let { exoplayer ->
            //現在の再生位置を保存
            this@RightHandedLayoutFragment.playbackPosition = exoplayer.currentPosition
            //ウィンドウインデックスを保存
            this@RightHandedLayoutFragment.currentWindow = exoplayer.currentMediaItemIndex
            //再生・一時停止状態を保存
            this@RightHandedLayoutFragment.playWhenReady = exoplayer.playWhenReady
            exoplayer.release()
        }
        player = null
    }
